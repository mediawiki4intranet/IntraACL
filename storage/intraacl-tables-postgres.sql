...
CREATE INDEX /*_*/intraacl_rules_child ON /*_*/intraacl_rules (child_type, child_id);
...
CREATE INDEX /*_*/intraacl_quickacl_pe ON /*_*/intraacl_quickacl (pe_type, pe_id);
...
CREATE INDEX /*_*/intraacl_badlinks_bl ON /*_*/intraacl_badlinks (bl_namespace, bl_title);
