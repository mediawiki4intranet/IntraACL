...
//    'hacl_definitions_will_not_be_saved' => '(The definitions in this article will not be saved and they will not be taken to effect due to the following errors.)',
    ...
    'hacl_non_canonical_acl'            => 'This ACL title is deprecated and will break in new versions. Please use an ACL with canonical name: [[$1]].',
...
$messages['ru'] = array(
    ...
    'hacl_non_canonical_acl'            => 'Данное имя определения является устаревшим и перестанет работать в будущих версиях. Используйте определение с каноническим именем: [[$1]].',
