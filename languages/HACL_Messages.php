...
Если вы хотите что-то защитить, создавайте статьи с именами: ACL:Page/*, ACL:Category/*, ACL:Namespace/*, ACL:Property/*, ACL:Right/*.',
    ...
    'hacl_edit_define_manager'          => 'Ошибка: ACL должен включать хотя бы одно право модификации!',
    'hacl_edit_define_tmanager'         => 'Ошибка: Шаблон прав должен включать хотя бы одно право на изменение шаблона!',
    ...
    'hacl_edit_action_manage'           => 'Защита страниц',
