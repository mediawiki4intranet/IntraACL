...
You have no read access to the <tt>File</tt> namespace. You will <b>not</b> be able to view the file after uploading!
    ...
    'hacl_category_acl_shown'           => '<p><img src="$3" /> This is the category ACL affecting <b>both</b> category page and category members. To see category page ACL, click here: <a href="$2">$1</a>.</p><hr />',
    'hacl_category_page_acl_shown'      => '<p><img src="$3" /> This is the category page ACL affecting <b>only</b> the category page, but not its members. To see category ACL, click here: <a href="$2">$1</a>.</p><hr />',
    'hacl_page_acl_shown'               => '<p><img src="$3" /> This is the page ACL affecting <b>only</b> the page itself, but not its subpages. To see page tree ACL, click here: <a href="$2">$1</a>.</p><hr />',
    'hacl_tree_acl_shown'               => '<p><img src="$3" /> This is the page tree ACL affecting <b>both</b> page itself and its subpages. To see page ACL, click here: <a href="$2">$1</a>.</p><hr />',
    'hacl_tab_acl'                      => 'ACL',
    'hacl_tab_page'                     => 'Page',
...
У вас доступа на чтение пространства имён Файл. Вы <b>не сможете</b> просмотреть файл после загрузки!
    ...
    'hacl_category_acl_shown'           => '<p><img src="$3" /> Это ACL категории, действующий и на страницу категории, и на её содержимое. Чтобы просмотреть ACL страницы категории, нажмите сюда: <a href="$2">$1</a>.</p><hr />',
    'hacl_category_page_acl_shown'      => '<p><img src="$3" /> Это ACL страницы категории, не действующий на содержимое категории. Чтобы просмотреть ACL категории, нажмите сюда: <a href="$2">$1</a>.</p><hr />',
    'hacl_page_acl_shown'               => '<p><img src="$3" /> Это ACL страницы, действующий только на данную страницу, но не на её подстраницы. Чтобы просмотреть ACL дерева страниц, нажмите сюда: <a href="$2">$1</a>.</p><hr />',
    'hacl_tree_acl_shown'               => '<p><img src="$3" /> Это ACL дерева страниц, действующий как на саму страницу, так и на её подстраницы. Чтобы просмотреть ACL самой страницы, нажмите сюда: <a href="$2">$1</a>.</p><hr />',
    'hacl_tab_acl'                      => 'ACL',
