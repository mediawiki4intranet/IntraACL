...
//    'hacl_definitions_will_not_be_saved' => '(The definitions in this article will not be saved and they will not be taken to effect due to the following errors.)',
    ...
    'hacl_non_canonical_acl'            => 'This ACL has non-canonical title. You may experience problems.',
...
$messages['ru'] = array(
    ...
    'hacl_non_canonical_acl'            => 'Данное определение имеет неканоническое имя. Это может вести к проблемам.',
