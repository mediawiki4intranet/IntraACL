...
You have no read access to the <tt>File</tt> namespace. You will <b>not</b> be able to view the file after uploading!
    ...
    'hacl_category_page_acl_shown'      => '<p><img src="$3" /> This is the category page ACL affecting <b>only</b> category page, not members. To see category ACL, click here: <a href="$2">$1</a>.</p><hr />',
    'hacl_tab_acl'                      => 'ACL',
    'hacl_tab_page'                     => 'Page',
