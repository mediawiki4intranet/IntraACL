...
//    'hacl_definitions_will_not_be_saved' => '(The definitions in this article will not be saved and they will not be taken to effect due to the following errors.)',
    ...
    'hacl_non_canonical_acl'            => 'Please use ACL with a canonical name: <b><a href="$1">$2</a></b>. <b>$3</b> is deprecated and will break in new versions.',
...
$messages['ru'] = array(
    ...
    'hacl_non_canonical_acl'            => 'Используйте определение с каноническим именем: <b><a href="$1">$2</a></b>. Имя <b>$3</b> является устаревшим и перестанет работать в будущих версиях.',
