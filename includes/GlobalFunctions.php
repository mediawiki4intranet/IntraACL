...
function haclfSetupExtension()
{
    ...
    if (!empty($_SERVER['SERVER_NAME']))
    {
        ...
        $wgHooks['SpecialUploadCheckWarnings'][] = 'IACLToolbar::onSpecialUploadCheckWarnings';
        $wgHooks['PerformUpload'][] = 'IACLToolbar::onPerformUpload';
...
class DeferCreatePermissionDenied
{
    static function execute()
    {
        ...
        if (!$t->getArticleId())
        {
            ...
            $a = new WikiPage($t);
            $a->doEditContent(ContentHandler::makeContent($haclgContLang->getPermissionDeniedPageContent(), $t), "", EDIT_NEW);
            echo "done.\n";
        }
    }
}
